// @TODO sample config
// @TODO how to dynamic get it
export const issuer = 'http://localhost:3000/openid';
export const config = {
  claims: {
    address: {
      address: null,
...
export const clients = [{
  ...
  redirect_uris: ['http://192.168.3.123:3000/front.html', 'http://192.168.3.123:3000/auth/provider'],
  post_logout_redirect_uris: ['http://192.168.3.123:3000/index.html'],
}];
